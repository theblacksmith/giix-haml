...
var inflections = Inflector.inflections = {
    plurals: [],
    singulars: [],
    uncountables: [],
    humans: []
 ...
 *   "authorKey"       => "author"
 */
Inflector.humanize = function (word) {
    ...
    return Inflector.split(word, " ").toLowerCase();
}

/**
 * Split a camel case word in its terms.
 */
Inflector.split = function (word, delim) {
    delim = delim || " ";
 ...
 */
Inflector.underscore = function (word) {
    return Inflector.split(word, "_").toLowerCase();
}

/**
 * Converts a CamelCase word to dash (lisp style) format.
 */
Inflector.dash = Inflector.dasherize = function (word) {
    return Inflector.split(word, "-").toLowerCase();
}
